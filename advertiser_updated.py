...
for i, blob in enumerate(bloblist):
	# print "Page: " + str(i)
	scores = {word: tfidf(word, blob, bloblist) for word in adContentLabels}
...
for i in range(len(result_list)):
	print str(result_list[i]["date"]) + ":" + str(result_list[i]["page"]) +":" +  str(result_list[i]["count"]) +":" +  str(scoreList[i])
